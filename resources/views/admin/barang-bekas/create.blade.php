...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Barang Bekas</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Barang Bekas</h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kondisi" class="form-select @error('kondisi') is-invalid @enderror" required>
                                ...
                                <option value="bekas_sangat_baik" {{ old('kondisi') == 'bekas_sangat_baik' ? 'selected' : '' }}>Bekas - Sangat Baik</option>
                                <option value="bekas_baik" {{ old('kondisi') == 'bekas_baik' ? 'selected' : '' }}>Bekas - Baik</option>
                                <option value="bekas_cukup" {{ old('kondisi') == 'bekas_cukup' ? 'selected' : '' }}>Bekas - Cukup</option>
                            </select>
                            @error('kondisi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="estimasi_poin" class="form-control @error('estimasi_poin') is-invalid @enderror" 
                                   value="{{ old('estimasi_poin') }}" min="0" required>
                            @error('estimasi_poin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
